...
Y_key = "train_ecog_"
os.makedirs(output_folder/f"dim_{dim}_Buffer",exist_ok=True)
model =  FeatureEncodingBufferNoKernel(
            ...
            timegen=False,
            times_id = [0],
            output_folder=output_folder/f"dim_{dim}_Buffer",
...
import pickle
from pathlib import Path
output_folder = proj/"featurereg_timecourseBestMix_Alpes"/"mingomni"/"mingomni_1.5"/"audio"/f"dim_{dim}_Buffer"
